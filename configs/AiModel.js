...
const contents = [
  {
    ...
    parts: [
      {
        text: `Write a script to generate 30 seconds video on topic: interesting  
        historical story along with AI image prompt in Realistic format for each scene and give me result 
        in JSON format with imagePrompt and ContentText as field, No Plain text`,
      },
    ],
  },
  // {
...
// Previous implementation using @google/generative-ai
// const {
//   GoogleGenerativeAI,
//   HarmCategory,
//   HarmBlockThreshold,
